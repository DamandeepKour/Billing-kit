...
export class TransactionService {
  ...
  async getRevenueByCurrency(filter?: ReportingFilter): Promise<{
  ...
  async getSettlementSummary(filter?: ReportingFilter): Promise<SettlementSummary> {
    ...
    for (const txn of transactions) {
      ...
      const p =
        byPresentment.get(presentmentCurrency) ?? emptyBucket(presentmentCurrency);
